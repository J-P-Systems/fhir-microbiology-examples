...
This page describes each pattern in detail with structure diagrams.

---

### Example 1: Flat

**File:** `microExample_1_flat.json`
...
**File:** `microExample_2_members.json`
...
**File:** `microExample_3_focus.json`
...
**File:** `microExample_4_isolate.json`
...
**File:** `microExample_5_groupers.json`
...
### Example 6: One Grouper

**File:** `microExample_6_onegrouper.json`
...
### Example 7: 4-Layer Groupers

**File:** `microExample_7_4layergroupers.json`
...
### Example 8: Isolate without hasMember

**File:** `microExample_8_isolate_no_hasmember.json`
